...
def ClientSocket(num,flag,x,y,depth):
    ...
    print(data1)
    '''
    judgement for mutiplay oranges
    '''
    #judge first for different retrun
    # the inverse position is different from the forward position
    if data1=='wrong':
        print('next orange')
        flag=flag+1
        flag1=0
    # the orange is out of range
    if data1=='cant reach':
        print("cant reach")
        flag1=0
        flag=flag+1
    ...
    while flag1:
        ...
        if data1=='wrong':
            ...
            break
    if flag>num:
        print('no appropriate orange in range!')
        print('Please change an area')
        time.sleep(100)
        flag=1
    return flag
    #if len(data1)>0:
